 ...
 */
case class SeqEvent(sourceAddress: String, value: Long) {

  override def toString: String = {
    s"Event ${sourceAddress} : ${value}"
  }
}
 ...
 */
case class SeqAlert(address: String, oldVal: Long, newVal: Long) {

  override def toString: String = {
    s"ALERT ${address} : ${oldVal} -> ${newVal}"
  }
}
